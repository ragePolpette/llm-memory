...
class Config(BaseModel):
    ...
    fast_memory_agent_distillation_apply_enabled: bool = Field(
        default_factory=lambda: _env_bool("FAST_MEMORY_AGENT_DISTILLATION_APPLY_ENABLED", False)
    )
    ...
    def startup_diagnostics(self) -> dict[str, object]:
        return {
            ...
            "fast_memory_agent_distillation_apply_enabled": self.fast_memory_agent_distillation_apply_enabled,
